 ...
 * name.
 * It is a extended version of opennlp.tools.util.featuregen.FeatureGeneratorResourceProvider
 * to support putting new resources.
 * <p>
 * <b>Note:</b><br>
...
public interface FeatureGeneratorResourceProvider {
  ...
  void putResource(String resourceIdentifier, Object resource);
}
